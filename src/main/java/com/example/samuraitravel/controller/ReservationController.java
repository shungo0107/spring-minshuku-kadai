...
public class ReservationController {
    ...
    /* メソッドの主な役割は、予約フォームの入力内容をチェックし、
     * 問題がなければ予約内容の確認ページにリダイレクトさせること。
     */
    ...
    /*メソッドの主な役割は、input()メソッドから渡されたReservationInputFormオブジェクトをもとに
     * ReservationRegisterFormオブジェクトを生成し、予約内容の確認ページを表示すること
     */
