...
public class ReservationService {
    ...
    @Transactional
    /*paymentIntentObjectは支払い情報のメタデータが含まれているオブジェクトで、
     * get()メソッドにメタデータ名を渡すことでその値を取得することができます
     * （例：paymentIntentObject.get("houseId")）。
     * なおこのメタデータというのは、StripeServiceクラスのcreateStripeSession()メソッドで
     * セッションを作成したときに入れたものです
     */
    ...
    // 宿泊料金を計算する
    /* calculateAmount()メソッド内ではChronoUnit.DAYS.between()メソッドを使い、
     * 2つの日付（LocalDate型）の間の日数、つまり宿泊日数を計算しています。
     * そして1泊あたりの宿泊料金にその宿泊日数を乗算することで、宿泊料金を算出しています。
     */
